...
We take a first look at the SSVS by examining multidimensional scaling plots from participant self-ratings. We compare to an MDS plot from the correlation matrix reported in a landmark study. Although not identical, and not quite as circular we do observe most of the expected patterns. 
