...
speeches_ethnicity_specs <- spec_out(
  ...
  x="Ethnicity", 
  controls=c("Sex", "Age", "perceived_party", "familiar", "c", "year", "spectrum", "party"), 
  formula_addition="Ethnicity*party")

speeches_spectrum_specs <- spec_out(
  df=wave_2_dfs$wave_2_speeches, 
  x="spectrum", 
  controls=c("Sex", "Age", "perceived_party", "familiar", "c", "year", "Ethnicity", "party"), 
...
```{r}
wave_2_lyrics_ethnicity_curve_df <- run_spec_curve(lyrics_ethnicity_specs, df = wave_2_dfs$wave_2_lyrics)
